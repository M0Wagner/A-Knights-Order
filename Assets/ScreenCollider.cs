...
public class ScreenCollider : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        collidingRB.linearVelocity = Vector3.Reflect(collision.transform.GetComponent<Rigidbody2D>().linearVelocity, -collision.contacts[0].normal);
    }
    ...
    void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        RaycastHit2D[] hit2D = Physics2D.RaycastAll(collider.transform.position, colliderRB.linearVelocity);
        ...
        colliderRB.linearVelocity = Vector2.Reflect(colliderRB.linearVelocity, normal);
    }
